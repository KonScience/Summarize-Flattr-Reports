...
export_png <- function(plot, filename, height, width){
...
export_png(flattr_plot, "flattr-revenue-clicks")
...
export_png(monthly_advanced_plot, "flattr-revenue-months", height = N_things/3, width = N_months/1.5)
